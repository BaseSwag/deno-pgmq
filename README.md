...
Due to a [Deno bug](https://github.com/denoland/deno/issues/22392), please make
sure that you are using Deno 1.44.1 or later. If you are using this library with
Supabase edge functions, make sure that the reported runtime compatibility
matches this (example below):
